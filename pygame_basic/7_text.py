...
# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("/home/dlwprmaksaks/Code/GameDevelop/pygame_basic/background.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("/home/dlwprmaksaks/Code/GameDevelop/pygame_basic/background.png")
